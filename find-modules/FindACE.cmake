...
if(NOT TARGET ACE::ACE)
  ...
  if(ACE_MAJOR_VERSION GREATER_EQUAL 8)
    # See https://github.com/DOCGroup/ACE_TAO/blob/ACE%2BTAO-8_0_0/ACE/ace/Global_Macros.h#L60
    set_property(TARGET ACE::ACE APPEND PROPERTY INTERFACE_COMPILE_FEATURES cxx_std_17)
  endif()
...
if(NOT TARGET ACE::ACE_INLINE)
  ...
  if(ACE_MAJOR_VERSION GREATER_EQUAL 8)
    # See https://github.com/DOCGroup/ACE_TAO/blob/ACE%2BTAO-8_0_0/ACE/ace/Global_Macros.h#L60
    set_property(TARGET ACE::ACE_INLINE APPEND PROPERTY INTERFACE_COMPILE_FEATURES cxx_std_17)
  endif()
endif()
